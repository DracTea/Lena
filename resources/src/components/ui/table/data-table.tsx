...
import { Renew } from '@/components/ui/icons';
import { Text } from '../common';
import SearchField from '../fields/search-field';
import { Button } from '../buttons';
import { useRouter } from '../router';
import { debounce, getValue } from '@/globals/utils';
import Pagination from './pagination';
import DataTableAction from './data-table-action';
// OverflowMenuVertical {scheme.table.actions.map((action) => (<span>{action.label}</span>))}
...
function TableData({ scheme, items }: Props) {
